...
<section className="section section-dark"><div className="container"><div className="eyebrow">{t.industries.eyebrow}</div><h2>{t.industries.title}</h2><div className="industry-list">{t.industries.items.map(([name])=><Link className="industry-pill" href={`/${locale}/industries`} key={name}>{name}</Link>)}</div></div></section>
