...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}){const {locale}=await params;const t=getContent(locale);return {title:t.pages.solutions.title,description:t.pages.solutions.intro,alternates:{canonical:`/${locale}/solutions`,languages:{en:'/en/solutions',fr:'/fr/solutions'}}}}
